...
class MeetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meet" do
    assert_difference('Meet.count') do
      post meets_url, params: { meet: { date: @meet.date, description: @meet.description, image: @meet.image, title: @meet.title } }
    end
  ...
  test "should update meet" do
    patch meet_url(@meet), params: { meet: { date: @meet.date, description: @meet.description, image: @meet.image, title: @meet.title } }
